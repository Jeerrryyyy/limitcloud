...
import com.jevzo.limitcloud.library.event.listener.EventHandler
import com.jevzo.limitcloud.library.event.listener.EventListener
...
class EventManager {
    ...
    fun registerListener(eventListener: EventListener) {
        listeners.add(eventListener::class.java)
    }
